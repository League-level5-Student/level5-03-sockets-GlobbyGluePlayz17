	...
	public void run() {
		...
		while (b) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "A client has connected to the server.");
			...
			//6. If the program catches a SocketTimeoutException, let the user know about it and set loop's boolean variable to false.
				...
				JOptionPane.showMessageDialog(null, "Program has caught a SocketTimeoutException.");
				b = false;
			}
			//7. If the program catches a IOException, let the user know about it and set the loop's boolean variable to false.
			catch (IOException e) {
				JOptionPane.showMessageDialog(null, "Program has caught a IOException.");
				b = false;
			}
		}
	}
